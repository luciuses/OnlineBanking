...
{
    public static OnlineBankingForManager.WebUI.Controllers.AccountController Account = new OnlineBankingForManager.WebUI.Controllers.T4MVC_AccountController();
    public static OnlineBankingForManager.WebUI.Controllers.ManagerController Manager = new OnlineBankingForManager.WebUI.Controllers.T4MVC_ManagerController();
...
namespace Links
{
    ...
    public static class Scripts {
        ...
        public static readonly string jquery_printElement_js = T4MVCHelpers.IsProduction() && T4Extensions.FileExists(URLPATH + "/jquery.printElement.min.js") ? Url("jquery.printElement.min.js") : Url("jquery.printElement.js");
        ...
        public static readonly string less_1_7_0_js = T4MVCHelpers.IsProduction() && T4Extensions.FileExists(URLPATH + "/less-1.7.0.min.js") ? Url("less-1.7.0.min.js") : Url("less-1.7.0.js");
    ...
    public static class Content {
        ...
        public static string Url() { return T4MVCHelpers.ProcessVirtualPath(URLPATH); }
        public static string Url(string fileName) { return T4MVCHelpers.ProcessVirtualPath(URLPATH + "/" + fileName); }
        public static readonly string EditStyle_less = Url("EditStyle.less");
        [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
        public static class Image {
            private const string URLPATH = "~/Content/Image";
            public static string Url() { return T4MVCHelpers.ProcessVirtualPath(URLPATH); }
            public static string Url(string fileName) { return T4MVCHelpers.ProcessVirtualPath(URLPATH + "/" + fileName); }
            public static readonly string Delete_Icon_16_png = Url("Delete_Icon_16.png");
            public static readonly string logo_png = Url("logo.png");
        }
    
        public static readonly string jquery_qtip_min_css = Url("jquery.qtip.min.css");
        public static readonly string ListStyle_less = Url("ListStyle.less");
        public static readonly string LoginStyle_less = Url("LoginStyle.less");
        public static readonly string MainStyle_less = Url("MainStyle.less");
        public static readonly string PrintListStyle_less = Url("PrintListStyle.less");
        public static readonly string PrintListStyle_css = T4MVCHelpers.IsProduction() && T4Extensions.FileExists(URLPATH + "/PrintListStyle.min.css") ? Url("PrintListStyle.min.css") : Url("PrintListStyle.css");
             
        public static readonly string PrintListStyle_min_css = Url("PrintListStyle.min.css");
        public static readonly string RegisterStyle_less = Url("RegisterStyle.less");
        [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
        ...
        public static readonly string UnLockStyle_less = Url("UnLockStyle.less");
    }
